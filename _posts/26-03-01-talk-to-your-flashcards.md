...
This is a [Claude Code](https://docs.anthropic.com/en/docs/claude-code) skill that connects to [Anki](https://apps.ankiweb.net/) via the [AnkiConnect](https://foosoft.net/projects/anki-connect/) add-on. Drop it into your skills folder and you can ask Claude to work with your flashcards directly.
